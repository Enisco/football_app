...
class FlutterwaveGateway extends StatefulWidget {
  const FlutterwaveGateway({Key? key}) : super(key: key);

  @override
  State<FlutterwaveGateway> createState() => _FlutterwaveGatewayState();
}

class _FlutterwaveGatewayState extends State<FlutterwaveGateway> {
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => PayStackGateway()),
                            );
                          },
                          child: Text(
                            'PAYSTACK',
